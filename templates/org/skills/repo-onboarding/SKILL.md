...
5. Should findings be **captured as docs** (run
   `/documentation-and-adrs`) or just explained?
...
`/documentation-and-adrs` to write an onboarding/architecture doc and
`/refresh-docs` to keep it in sync. No implementation agents — this
