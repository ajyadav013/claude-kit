...
- [ ] **Install and configure-anytime UX**
...
- [ ] **Provider-neutral skill with native Codex projection**
...
- [ ] **Authoritative maker–checker loop**
...
- [ ] **Cross-host documentation and conformance**
