...
# The guidance returns as hookSpecificOutput.additionalContext JSON on stdout (Codex reads it next
...
Guardrails (opt-in) -- see .agents/skills/security-and-hardening/SKILL.md -> 'LLM / AI Feature Security' (OWASP LLM Top 10):
