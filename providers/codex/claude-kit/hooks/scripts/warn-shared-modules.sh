...
# Warnings return as hookSpecificOutput.additionalContext JSON on stdout (Codex reads it next to
...
case "$base" in
  ...
  Dockerfile|docker-compose.yml|docker-compose.*.yml|Makefile|AGENTS.md)
...
case "$FILE_PATH" in
  */.github/workflows/*|*/.gitlab-ci.yml|*azure-pipelines.yml|*/.ckit/rules/*|*/.ckit/settings*.json|*/.codex/agents/*)
