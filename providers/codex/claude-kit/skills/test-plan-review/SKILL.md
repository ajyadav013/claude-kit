...
- You need coverage thresholds/standards → `testing`.
...
Cosmetic** (`quality-gates`). Keep "Gaps to Fix" and "Improvements" strictly
...
- `testing` — coverage thresholds and per-test standards.
