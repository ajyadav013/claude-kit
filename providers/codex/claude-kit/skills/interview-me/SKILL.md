---
name: interview-me
description: Extracts what the user actually wants via one-question-at-a-time interview until ~95% confidence. Use when an ask is underspecified ("build me X" with no who/why) or the user invokes ("interview me").
---
