---
name: execute
description: Takes raw text/requirement, optimizes it into a precise prompt, then executes it immediately. Use when you have a rough idea and want Codex to refine and act on it in one step.
---

You received raw text from the user: the invocation request
...
Now execute the optimized prompt as if the user had typed it directly. Follow all project rules (AGENTS.md, mandatory workflow, etc.) and complete the task end-to-end.
