...
uniformly. Use `risk-classification` to place the change:
...
- `risk-classification` — sets the consequence tier that gates how much of this to apply
...
- `testing` — assertions complement, never replace, the runnable test for non-trivial logic
