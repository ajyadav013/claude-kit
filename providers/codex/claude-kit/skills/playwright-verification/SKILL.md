...
Run E2E verification for: the invocation request.

## Steps

1. **Determine test scope**: Based on `the invocation request`, select the test scope according to the project's E2E framework configuration. Common patterns:
