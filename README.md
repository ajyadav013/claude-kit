...
| 📐 **Rules & skills** | **25** stack-agnostic core rules + **110** context-activated skills (57 core + 53 stack-collection), pulled into context on demand |
...
| **dotfiles / `CLAUDE.md` starters** | A single rules file or settings snippet | A catalog-driven generator: resolves your stack/profile/scope into the right subset of 25 rules, 29 agents, 110 skills, gates, and hooks — kept upgradeable with your edits preserved |
