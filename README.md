...
| 📐 **Rules & skills** | **25** stack-agnostic core rules + **109** context-activated skills (57 core + 52 stack-collection), pulled into context on demand |
...
| **dotfiles / `CLAUDE.md` starters** | A single rules file or settings snippet | A catalog-driven generator: resolves your stack/profile/scope into the right subset of 25 rules, 29 agents, 109 skills, gates, and hooks — kept upgradeable with your edits preserved |
