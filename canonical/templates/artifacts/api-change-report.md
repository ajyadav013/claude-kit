...
## Removed / deprecated
- <removed or renamed endpoint/field> — deprecation + removal plan: <link to `skill://deprecation-and-migration` output>
...
- **contract-clear:** <PASS / FAIL> (PASS only at zero Critical/High/Medium per `rule://quality-gates`)
