...
- Design system location (if one exists — check `rule://ui-design-system` (React overlay; its `ui-components.md` / `ui-layout-and-motion.md` companions cover components and layout/motion/a11y), `docs/references/ui/`, `design-system/`, or similar)
...
5. `rule://responsive-and-accessibility` — responsive design and a11y rules
