...
3. **`rule://testing`** — testing guide with coverage thresholds, patterns, and project-specific test frameworks
...
Use the project's test framework (check `rule://testing` for specifics). Common patterns:
...
# See rule://testing for the exact commands
```
