...
- `skill://performance-optimization`
- `skill://security-verification`
- `skill://playwright-verification` (or equivalent E2E skill)

## Rules — MANDATORY

Before writing any frontend code:

1. `rule://frontend-best-practices` — naming, imports, patterns, framework-specific anti-patterns
2. `rule://linting-and-formatting` — linter/formatter standards
3. `rule://design-patterns` — Container/Presentational, Custom Hook, Store, API Client, Error Boundary patterns
4. `rule://code-organization` — module layout and conventions
5. If the feature targets mobile surfaces: `rule://responsive-and-accessibility`
...
2. Read `rule://frontend-best-practices`
3. Read `rule://documentation` — file-level docstrings, function docstrings, explicit return types, README updates
