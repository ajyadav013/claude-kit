...
- You need coverage thresholds/standards → `rule://testing`.
...
Cosmetic** (`rule://quality-gates`). Keep "Gaps to Fix" and "Improvements" strictly
...
- `rule://testing` — coverage thresholds and per-test standards.
