...
request_input:
  mode: optional
  hint: '[page route, "smoke", "all", or "cross-browser"]'
pause_for_human: []
references: []
---

Run E2E verification for: {{request}}.

## Steps

1. **Determine test scope**: Based on `{{request}}`, select the test scope according to the project's E2E framework configuration. Common patterns:
