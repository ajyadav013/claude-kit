...
request_input:
  mode: optional
  hint: '[component or hook name]'
pause_for_human: []
references: []
---

Write unit tests for: {{request}}.

## Steps

1. **Read the target code**: Read the component or hook file for `{{request}}` to understand its props, behavior, state, and edge cases.
