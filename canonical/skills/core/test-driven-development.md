...
description: Drives development with tests — red-green-refactor, Prove-It Pattern for bugs, test pyramid, property-based testing. Do NOT use when no spec exists yet (use spec-driven-development first).
invocation: implicit
capabilities:
- filesystem.read
- filesystem.write
...
pause_for_human: []
references:
- artifact://skill-reference-testing-patterns
---
...
For detailed testing patterns, examples, and anti-patterns across frameworks, see `artifact://skill-reference-testing-patterns`.
