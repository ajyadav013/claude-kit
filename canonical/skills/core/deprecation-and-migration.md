...
"verify the target before a destructive change" rule in `rule://agent-guardrails` §3.
...
`rule://resilience-engineering`; this section is about using them to verify a migration
