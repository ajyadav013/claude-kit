...
request_input:
  mode: optional
  hint: '[page, component, or "bundle"]'
pause_for_human: []
references: []
---

Optimize performance for: {{request}}.

## Steps

1. **Identify the optimization target**: Determine if this is a bundle optimization, render performance issue, or Core Web Vitals improvement for `{{request}}`.
