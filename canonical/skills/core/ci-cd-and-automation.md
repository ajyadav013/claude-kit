...
Pick blue/green for atomic switch + instant revert, canary for gradual observable exposure. Either way, define the advance / hold / rollback thresholds **before** you start — reuse the Rollout Decision Thresholds table in `{{skill_file:skill://shipping-and-launch}}` rather than inventing new ones.
