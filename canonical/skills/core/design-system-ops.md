...
> (© 2026 Murphy Trueman). The original is a 41-skill pack for {{external_assistant:title}} Code; this is a single
...
- `rule://documentation` — the kit's documentation standard that design-system docs must meet.
