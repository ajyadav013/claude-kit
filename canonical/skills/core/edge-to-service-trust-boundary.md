---
schema_version: 1
id: edge-to-service-trust-boundary
description: Cryptographic trust contract between API gateway/edge and backend — edge HMAC-signs forwarded identity headers, services verify and FAIL CLOSED. Do NOT use for general app hardening or RBAC (use auth-and-rbac).
invocation: implicit
capabilities: []
request_input:
  mode: none
