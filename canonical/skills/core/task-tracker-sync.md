...
{{kit:cli}} does not assume a tracker. Use whichever **issue-tracker MCP server** is configured for
the project (see `artifact://mcp-configuration` / the catalog): GitHub, Linear, Jira, or another. Discover the
