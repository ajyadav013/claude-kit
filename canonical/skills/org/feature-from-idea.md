...
secrets, production data, migrations, infrastructure). See `rule://risk-classification`.
...
or it exceeds the active autonomy level (`rule://autonomy-levels`).
