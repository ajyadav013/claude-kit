...
- `rule://devops-observability` — observability policy (structured logging, metrics, tracing, no PII in telemetry)
- `rule://agent-resilience` — fail-safe init, env-gated startup, graceful degradation
