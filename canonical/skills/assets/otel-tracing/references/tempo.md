...
- `rule://devops-observability` — observability policy: structured logs, PII/secret redaction, metric/trace correlation, `service.name` requirement, sampling strategy, retention bounds.
