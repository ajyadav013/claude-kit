...
## Contributing
Link to artifact://project-instructions for the engineering delivery workflow.
```
...
measurement prose, and gate proofs live at their `state://workflow/` or artifact path, cited by path
(`rule://quality-gates` §2.5). Requirement and decision updates are always welcome in the
