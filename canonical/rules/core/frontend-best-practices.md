...
- `rule://code-organization` — module structure, file organization
- `rule://linting-and-formatting` — linter/formatter rules, code style
- `rule://testing` — testing standards
- `rule://responsive-and-accessibility` — responsive design, accessibility standards
- `rule://documentation` — documentation requirements
