...
- Apply the project constraints in `CLAUDE.md`, the established structure in
  `.claude/rules/code-organization.md`, the UI conventions in `.claude/rules/frontend-best-practices.md`, the concrete
  accessibility contract in `.claude/rules/responsive-and-accessibility.md`, and the verification
  expectations in `.claude/rules/testing.md`.
